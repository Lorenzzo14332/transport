                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate method="POST"
                                        ...
                                        <div class="col-12">
                                            <label for="yourUsername" class="form-label"> Dirección de correo electrónico</label>
                                            <div class="input-group has-validation">
                                                ...
                                                <div class="invalid-feedback">
                                                    Por favor, introduzca su nombre de usuario.</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">no tienes cuenta? <a
                                                    href="register">Crea una cuenta</a></p>
                                        </div>
                                    </form>
